...
class TelaColheita:
    ...
    def colheita(self):
        ...
        tabela=Tabela(self.page, self.checar_estado).tabela(["ID", "Quantidade colhida"], ["colheita_id", "quantidade_colhida"], "harvests", "harvest")
        ...
        titulo_dashboard=ft.Container(
            ...
            expand=True,
            content=ft.Text("COLHEITAS",size=25)
        )
